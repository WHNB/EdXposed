package com.android.system.riru.edxp.sandhook.dexmaker;

import com.android.system.riru.edxp.util.FileUtils;
import com.android.system.riru.edxp.util.ProcessUtils;
...
public final class DynamicBridge {
    ...
    public static synchronized void hookMethod(Member hookMethod, XposedBridge.AdditionalHookInfo additionalHookInfo) {
        ...
        try {
            ...
            if (!DexMakerUtils.shouldUseInMemoryHook()) {
                setupDexCachePath();
            }
    ...
    private static void setupDexCachePath() {
        ...
        try {
            ...
            String fixedAppDataDir = FileUtils.getDataPathPrefix() + FileUtils.getPackageName(ConfigManager.appDataDir) + "/";
            dexDir = new File(fixedAppDataDir, "/cache/edhookers/"
                    + ProcessUtils.getCurrentProcessName(ConfigManager.appProcessName).replace(":", "_") + "/");
            dexDir.mkdirs();
